...
if not DEBUG:
    ...
    #SECURE_SSL_REDIRECT = True # This causes infinite redirects because of some proxy header thing
...
if not DEBUG or FORCE_USE_POSTGRESQL:
    DATABASES = {
        'default': {
            ...
            'NAME': 'django',
            'USER': 'django',
            'PASSWORD': config('DJANGO_POSTGRES_PASS'),
            'HOST': 'localhost',
            'PORT': '',
        }
    }
